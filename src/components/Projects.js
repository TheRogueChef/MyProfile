...
const Projects = () => {
    return (
        <div className='pShell'>
            <h1 style={{ fontFamily: 'SokaRegular', textDecoration: 'underline', textShadow: '.2rem .2rem black'}}>Projects</h1>
            <br />
            <div className='pBox'>
                    <Image className='plogo' src={KitSyncLogo} alt='...' />
                    <h1 style={{ fontSize: '2rem'}}>Kitchen Sync</h1>
            ...
            <div className='pBox'>
                    ...
                    <h1 style={{ fontSize: '2rem'}}>Author, Author</h1>
                <div className='pLinkBox'>
                    <br/>
            ...
            <div className='pBox'>
                    ...
                    <h1 style={{ fontSize: '2rem'}}>Product Manager</h1>
                <div className='pLinkBox'>
                    <br/>
