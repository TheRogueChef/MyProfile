    ...
    return (
        <div className='AMShell'  >
            <div >
                ...
                <div>
                    <p>Driven junior web developer and software designer who has successfully navigated a long and prosperous career as an artistic talented Executive Chef, company leader and team motivator successful at maintaining staff focus and productivity in high-volume, fast-paced operations. Now I utilize those artistic skills in designing cool web sites that bring friends together, offer a cool resource to the user or represent a business in an upscale, but still unique and detailed in functionality.</p>
